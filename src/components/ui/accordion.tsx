...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      {...props}
    >
      {/* <div className='bg-gradient-purple-pink group-data-[state=open]:animate-border-reveal absolute inset-0 z-0 rounded-2xl opacity-0 group-data-[state=open]:opacity-100' /> */}
