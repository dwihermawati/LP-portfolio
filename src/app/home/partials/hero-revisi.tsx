...
export const HeroRevisi: React.FC = () => {
  return (
    <section className='grid-hero circle-hero relative' id='home'>
      <div className='waves-hero mask-hero flex-center relative mask-alpha'>
        <div className='header-ellipse-decoration hero-ellipse-decoration relative h-full w-full'>
          ...
          <div
            ...
            style={{
              marginTop: generateClamp(104, 222, 1224),
              marginBottom: 'clamp(0px, max(0px, -72.1px + 20.02vw), 173px)',
